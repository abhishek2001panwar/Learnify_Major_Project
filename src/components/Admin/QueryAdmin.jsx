...
function QueryAdmin() {
  ...
  return (
    <>
          <h1 className="text-2xl font-light mb-10  mt-20 flex justify-center items-center">Queries</h1>
        <div className="mt-10  ">
              ...
              {query.map((query, index) => (
                <tr key={index}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap w-1/2 ">
                    <h1 className="w-1/2">{query.message.slice(0,40)}<Link className='text-blue-500' href={''} >...more</Link> </h1>
                  </td>
